...
packageJson.dependencies['eslint-plugin-vue'] = '7.9.0'
packageJson.dependencies['babel-eslint'] = '10.1.0'
packageJson.dependencies['eslint-config-cabinx'] = '1.0.0'
packageJson.dependencies['eslint-plugin-prettier'] = '3.4.0'
packageJson.dependencies.prettier = '2.2.1'
...
function run() {
  ...
  console.log('[Cabinx ESlint] 配置中同步中，请等待...')
