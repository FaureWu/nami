...
packageJson.dependencies.eslint = '7.*'
packageJson.dependencies['eslint-plugin-vue'] = '7.*'
packageJson.dependencies['babel-eslint'] = '10.*'
packageJson.dependencies['eslint-config-cabinx'] = '1.*'
packageJson.dependencies['eslint-plugin-prettier'] = '3.*'
packageJson.dependencies.prettier = '2.*'
packageJson.dependencies.husky = '4.*'
packageJson.dependencies['lint-staged'] = '10.*'
...
packageJson['lint-staged']['dev/**/*.{js,scss}'] = [
  "prettier --config .prettierrc --write ./dev",
  "eslint ./dev",
  "git add ."
]
